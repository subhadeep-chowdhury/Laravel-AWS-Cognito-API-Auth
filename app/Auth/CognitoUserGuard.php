...
class CognitoUserGuard implements Guard
{
	protected $request;
	protected $provider;
	protected $user;
	...
	*/
	...
	{
		$user = $this->provider->userByToken($token);
	...
	public function logoutUser()
	{
		...
		$this->provider->updateRememberToken($this->user->get(), NULL);
